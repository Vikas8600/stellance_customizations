...
def setup_lead_property_setters():
    property_setters = [
        ...
        {
            "name": "Prospect-annual_revenue-hidden",
            "doctype_or_field": "DocField",
            "doc_type": "Prospect",
